			...
			<div class="card">
				...
				<div class="card-body">
					<form action="{{url('admin/produk/filter')}}" method="post">
						...
						<button type="input" class="btn btn-dark float-right"><i class="fa fa-search"></i> Filter</button>
					</form>
				</div>
				</div>
			<div class="card">
				<div class="card-header">
					Data Produk
					<a href="{{url('admin/produk/create')}}" class="btn btn-dark float-right"><i class="fa fa-plus"></i> Tambah</a>
				</div>
				<div class="card-body">
